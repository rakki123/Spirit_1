...
public class AlgoNaiveBayesClassifier {
    ...
    private void runAlgorithm() throws Exception {
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("output.tsv"))));
        ...
        for (File f : listOfTrainingFiles) {
            ...
            mFileLists.put(f.getName(), Arrays.asList(classTraining));
		...
		String str1=new String(data);
                ...
                ConvolutionTreeKernel.jTextArea3.append("Testing: "+str1.trim()+"\n");
                ConvolutionTreeKernel.jTextArea3.append("Predicted Result: " + maxEntry.getKey()+"\n\n");
            }
            catch(Exception e)
            {
                e.printStackTrace();
